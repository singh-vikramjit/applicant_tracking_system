...
./vendor/bin/phpcs . --ignore=config/*,resources/*,storage/*,bootstrap/*,public/*,vendor/*,database/*,_ide_helper* --runtime-set ignore_warnings_on_exit true --standard=./.deploy/phpcs_ruleset.xml
